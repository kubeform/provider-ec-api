...
var trafficfiltersResource = schema.GroupVersionResource{Group: "deployment.ec.kubeform.com", Version: "v1alpha1", Resource: "trafficfilters"}

var trafficfiltersKind = schema.GroupVersionKind{Group: "deployment.ec.kubeform.com", Version: "v1alpha1", Kind: "TrafficFilter"}
...
func (c *FakeTrafficFilters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TrafficFilter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(trafficfiltersResource, c.ns, name), &v1alpha1.TrafficFilter{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TrafficFilter), err
}
...
func (c *FakeTrafficFilters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TrafficFilterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(trafficfiltersResource, trafficfiltersKind, c.ns, opts), &v1alpha1.TrafficFilterList{})
	...
	list := &v1alpha1.TrafficFilterList{ListMeta: obj.(*v1alpha1.TrafficFilterList).ListMeta}
	for _, item := range obj.(*v1alpha1.TrafficFilterList).Items {
...
func (c *FakeTrafficFilters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(trafficfiltersResource, c.ns, opts))
...
func (c *FakeTrafficFilters) Create(ctx context.Context, trafficFilter *v1alpha1.TrafficFilter, opts v1.CreateOptions) (result *v1alpha1.TrafficFilter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(trafficfiltersResource, c.ns, trafficFilter), &v1alpha1.TrafficFilter{})
...
func (c *FakeTrafficFilters) Update(ctx context.Context, trafficFilter *v1alpha1.TrafficFilter, opts v1.UpdateOptions) (result *v1alpha1.TrafficFilter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(trafficfiltersResource, c.ns, trafficFilter), &v1alpha1.TrafficFilter{})
...
func (c *FakeTrafficFilters) UpdateStatus(ctx context.Context, trafficFilter *v1alpha1.TrafficFilter, opts v1.UpdateOptions) (*v1alpha1.TrafficFilter, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(trafficfiltersResource, "status", c.ns, trafficFilter), &v1alpha1.TrafficFilter{})
...
func (c *FakeTrafficFilters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(trafficfiltersResource, c.ns, name), &v1alpha1.TrafficFilter{})
...
func (c *FakeTrafficFilters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(trafficfiltersResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TrafficFilterList{})
	return err
}
...
func (c *FakeTrafficFilters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TrafficFilter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(trafficfiltersResource, c.ns, name, pt, data, subresources...), &v1alpha1.TrafficFilter{})

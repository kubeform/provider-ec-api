...
// TrafficFilterAssociationsGetter has a method to return a TrafficFilterAssociationInterface.
...
// trafficFilterAssociations implements TrafficFilterAssociationInterface
type trafficFilterAssociations struct {
	client rest.Interface
	ns     string
}

// newTrafficFilterAssociations returns a TrafficFilterAssociations
func newTrafficFilterAssociations(c *DeploymentV1alpha1Client, namespace string) *trafficFilterAssociations {
	return &trafficFilterAssociations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *trafficFilterAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TrafficFilterAssociation, err error) {
	result = &v1alpha1.TrafficFilterAssociation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *trafficFilterAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TrafficFilterAssociationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TrafficFilterAssociationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("trafficfilterassociations").
...
func (c *trafficFilterAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *trafficFilterAssociations) Create(ctx context.Context, trafficFilterAssociation *v1alpha1.TrafficFilterAssociation, opts v1.CreateOptions) (result *v1alpha1.TrafficFilterAssociation, err error) {
	result = &v1alpha1.TrafficFilterAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("trafficfilterassociations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(trafficFilterAssociation).
		Do(ctx).
		Into(result)
	return
}
...
func (c *trafficFilterAssociations) Update(ctx context.Context, trafficFilterAssociation *v1alpha1.TrafficFilterAssociation, opts v1.UpdateOptions) (result *v1alpha1.TrafficFilterAssociation, err error) {
	result = &v1alpha1.TrafficFilterAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("trafficfilterassociations").
		Name(trafficFilterAssociation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(trafficFilterAssociation).
		Do(ctx).
		Into(result)
...
func (c *trafficFilterAssociations) UpdateStatus(ctx context.Context, trafficFilterAssociation *v1alpha1.TrafficFilterAssociation, opts v1.UpdateOptions) (result *v1alpha1.TrafficFilterAssociation, err error) {
	result = &v1alpha1.TrafficFilterAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("trafficfilterassociations").
...
func (c *trafficFilterAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *trafficFilterAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *trafficFilterAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TrafficFilterAssociation, err error) {
	result = &v1alpha1.TrafficFilterAssociation{}

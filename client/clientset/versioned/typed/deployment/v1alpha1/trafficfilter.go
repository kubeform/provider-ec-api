...
// TrafficFiltersGetter has a method to return a TrafficFilterInterface.
...
// trafficFilters implements TrafficFilterInterface
type trafficFilters struct {
	client rest.Interface
	ns     string
}

// newTrafficFilters returns a TrafficFilters
func newTrafficFilters(c *DeploymentV1alpha1Client, namespace string) *trafficFilters {
...
func (c *trafficFilters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TrafficFilter, err error) {
	result = &v1alpha1.TrafficFilter{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *trafficFilters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TrafficFilterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TrafficFilterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("trafficfilters").
...
func (c *trafficFilters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *trafficFilters) Create(ctx context.Context, trafficFilter *v1alpha1.TrafficFilter, opts v1.CreateOptions) (result *v1alpha1.TrafficFilter, err error) {
	result = &v1alpha1.TrafficFilter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("trafficfilters").
...
func (c *trafficFilters) Update(ctx context.Context, trafficFilter *v1alpha1.TrafficFilter, opts v1.UpdateOptions) (result *v1alpha1.TrafficFilter, err error) {
	result = &v1alpha1.TrafficFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("trafficfilters").
...
func (c *trafficFilters) UpdateStatus(ctx context.Context, trafficFilter *v1alpha1.TrafficFilter, opts v1.UpdateOptions) (result *v1alpha1.TrafficFilter, err error) {
	result = &v1alpha1.TrafficFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("trafficfilters").
...
func (c *trafficFilters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *trafficFilters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *trafficFilters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TrafficFilter, err error) {
	result = &v1alpha1.TrafficFilter{}

...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("trafficfilters"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Deployment().V1alpha1().TrafficFilters().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("trafficfilterassociations"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Deployment().V1alpha1().TrafficFilterAssociations().Informer()}, nil
